...
public class test_agent_script : MonoBehaviour
{
...
/*
    ...
    void Awake()
    {
        ...
        a_factory.add_action_to_list("start_moving", () => car_game.set_moving(true, basic.this_ob),);
        
        
        b_factory.add_belief("have_we_passed",  );
        b_factory.add_belief("are_we_moving", () => basic.this_ob.GetComponent<basics>().moving );
        ...
        g_factory.add_goal("win", new KeyValuePair<string, bool>("race_is_running", false), 0.1f, b_factory.grab_belief());
